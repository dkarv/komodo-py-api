...
class SystemCommand(BaseModel):
    ...
    shell_mode: Optional[bool] = Field(default=None)
...
class ExecutionTypes(str, Enum):
    ...
    UPDATE_SWARM_NODE = "UpdateSwarmNode"
...
class ExecutionUpdateSwarmNode(BaseModel):
    type: Literal[ExecutionTypes.UPDATE_SWARM_NODE] = ExecutionTypes.UPDATE_SWARM_NODE
...
class StackConfig(BaseModel):
    ...
    """
    auto_update_skip_services: Optional[List[str]] = Field(default=None)
    """
...
class Mount(BaseModel):
    ...
    """
    typ: Optional[MountType] = Field(alias="Type", default=None)
    """
...
class Topology(BaseModel):
    ...
    segments: Optional[Dict[str, str]] = Field(alias="Segments", default=None)
...
class UpdateSwarmNode(BaseModel):
    """
    ...
    Node hostname or id
    """
    availability: Optional[NodeSpecAvailabilityEnum] = Field(default=None)
    """
    Update the node's availability: 'active', 'pause', or 'drain'
    """
    label_add: Optional[List[str]] = Field(default=None)
    """
    Add labels to node (`key=value`).
    """
    label_rm: Optional[List[str]] = Field(default=None)
    """
    Add labels to node (`key=value`). (alias: `lr`)
    """
    role: Optional[NodeSpecRoleEnum] = Field(default=None)
    """
...
class ExecuteRequestUpdateSwarmNode(BaseModel):
    type: Literal[ExecuteRequestTypes.UPDATE_SWARM_NODE] = ExecuteRequestTypes.UPDATE_SWARM_NODE
    params: UpdateSwarmNode
